...
export class Api extends HttpClient {
    constructor() {
         ...
         * @request GET:/slandymani/blog/blog/comment
         */
        this.queryCommentAll = (query, params = {}) => this.request({
            path: `/slandymani/blog/blog/comment`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/slandymani/blog/blog/comment/{id}
         */
        this.queryComment = (id, params = {}) => this.request({
            path: `/slandymani/blog/blog/comment/${id}`,
            method: "GET",
            format: "json",
            ...params,
        });
